...
model = torch.hub.load('ultralytics/yolov5', 'custom', path=r'C:\Users\lenovo\OneDrive\Desktop\demo\Traffice-detection-public\Traffice-detection-public\app.py')  # Adjusted path
